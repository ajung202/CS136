...
public class SinglyLinkedList<E> : AbstractEnumerable<E>, IList<E>
{
    ...
    public class SLLEnumerator : AbstractEnumerator<E>
    {
      private readonly ListNode<E> start;
      private ListNode<E> cur;

      public SLLEnumerator(SinglyLinkedList<E> sll)
      {
        this.start = sll.start;
        cur = null;
      }
